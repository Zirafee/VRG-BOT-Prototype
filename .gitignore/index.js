...
bot.on('message', message => {
    ...
    bot.on("guildMemberAdd", member => {
        member.guild.channels.find("name", "rue-du-parlement").send(`Bienvenue à toi ${member} sur Vin Rage Gaming`)stop
    })
    
    bot.on("guildMemberRemove", member => {
        member.guild.channels.find("name", "rue-du-parlement").send(`Et voilà, ${member} est parti !`)stop
    })
